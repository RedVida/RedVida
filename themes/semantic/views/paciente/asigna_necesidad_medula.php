...
<script type="text/javascript">
	$(function(){
        $('#busquedaMedula').autocomplete({
       		 source : function( request, response ) {
       		 $.ajax({
                    url: '<?php echo $this->createUrl('Medula/MedulaList'); ?>',
                    dataType: "json",
    ...
    function successModal(){                     // Button - Modal Success 
        $("#necesidad-Medula-asigna_medula-form").submit();
    }
</script>
...
<div class="ui black ribbon label">
	<h1 class="ui huge header add icon"> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; Registrar Necesidad De Medula - <?php echo $paciente->nombre." ".$paciente->apellido?> </h1>
</div>

<div class="form">
	<?php $form=$this->beginWidget('CActiveForm', array(
		'id'=>'necesidad-Medula-asigna_medula-form',
			...
			<div class="twelve wide column">
				  <div class="ui form">
					  	<div class="four wide field">
					       ...
					       <?php echo CHtml::dropDownList('Medula[grado_urgencia]','', array('Bajo'=>'Bajo','Medio'=>'Medio','Alto'=>'Alto','Urgencia Nacional'=>'Urgencia Nacional'),array('empty' => 'Selecciona Grado Urgencia', 'class'=>'ui selection dropdown')); ?>
						</div>
					 	<div class="fields">
						 	<div class="four wide field">
								<?php echo $form->labelEx($model,'Tipo de Medula'); ?>
								<?php echo CHtml::textField('Medula[id]','',array('id'=>'busquedaMedula','placeholder'=>'Ingrese el Medula a buscar...')); ?>
								</div>
						</div>
						</div><br>
