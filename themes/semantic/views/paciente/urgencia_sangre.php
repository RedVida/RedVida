...
Urgencias Nacionales - Sangre(s) </h1>
</div>
<hr class="style-two ">

<?php 

              $sangres = Yii::app()->db->createCommand()
            ->select('p.id, p.nombre, p.apellido, org.tipo, nu.grado_urgencia ,nu.fecha')
            ->from('paciente p, necesidad_sangre nu, banco_sangre org ')
            ->where('p.id=nu.id_paciente AND nu.id=org.id ORDER BY nu.grado_urgencia="Alto" 
