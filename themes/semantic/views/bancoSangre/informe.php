...
Generar Informe - Banco de Sangre </h1>
</div>
<hr class="style-two ">
<div class="ui grid">
	 		...
	 		<div class="form">
				...
				<div class="ui form">
					...
					<div class="four wide field">
					       ...
					       <?php echo $form->dropDownList($model,'tipo',CHtml::listData(BancoSangre::model()->findAll(),'tipo', 'tipo'), array('empty' => 'Seleccione Tipo Sangre', 'class'=>'ui selection dropdown')); ?>
					</div>
				   </div>
					<br>
