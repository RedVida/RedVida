<?php 
	...
	*/
	...
	$editimgurl = Yii::app()->request->baseUrl."/themes/semantic/packaged/images/update.png";
	$handimgurl = Yii::app()->request->baseUrl."/themes/semantic/packaged/images/hand.png";
	$handoffimgurl = Yii::app()->request->baseUrl."/themes/semantic/packaged/images/hand-off.png";
...
<script>
	$('ul.auth-item li').each(function(){
		...
		var loadingUrl = '<?php echo Yii::app()->request->baseUrl."/themes/semantic/packaged/images/loading.gif"; ?>';
