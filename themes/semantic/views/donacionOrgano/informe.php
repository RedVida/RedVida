...
Generar Informe - Donación Órgano </h1>
</div>
<hr class="style-two ">
<div class="ui grid">
	 		...
	 		<div class="form">
				...
				<div class="ui form">
					...
					<div class="three wide field">
						...
						<?php echo CHtml::textField('DonacionOrgano[desde]','',array('data-field'=>'datetime','placeholder'=>'Fecha de inicio')); ?>
					 </div>
					 <div class="three wide field">
						<?php echo $form->labelEx($model,'Hasta:'); ?>
						<?php echo CHtml::textField('DonacionOrgano[hasta]','',array('data-field'=>'datetime','placeholder'=>'Fecha de termino')); ?>
					 </div>
 					<div id="dtBox"></div>
                    </div>
