...
class CrugeUser extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_centro_medico', 'required'),
			array('state, totalsessioncounter, currentsessioncounter, id_centro_medico', 'numerical', 'integerOnly'=>true),
			...
			array('iduser, regdate, actdate, logondate, username, email, password, authkey, state, totalsessioncounter, currentsessioncounter, id_centro_medico', 'safe', 'on'=>'search'),
		);
	}
